                    ...
                    <div class="shop_cart_wrap">
                        @empty(session('cart'))
                            <div class="alert alert-info" role="alert">
                                Cosul tau de cumparaturi nu contine produse. Pentru a adauga produse in cos te rugam <a href="/">sa te intorci in magazin</a>.
                            </div>
                        @endempty
                        @foreach ($CartProducts as $Product)
                            ...
                            <div class="single_shop_cart d-flex align-items-center flex-wrap">
                                <div class="cart_img mb-4 mb-md-0">
                                    <img loading="lazy" src="{{ route('ProductImage', $Product->MainImage) }}" alt="product">
                                </div>
                                <style>
